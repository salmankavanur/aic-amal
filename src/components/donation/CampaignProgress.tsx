  ...
  return (
    <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-xl">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white/20 backdrop-blur-sm p-5 rounded-xl hover:bg-white/30 transition-all duration-300">
          ...
          <div className="w-full bg-gray-200/30 dark:bg-gray-600/30 rounded-full h-2.5 mt-2">
            <div className="bg-purple-500/80 h-2.5 rounded-full" style={{ width: "40%" }}></div>
          </div>
        </div>
        ...
        <div className="bg-white/20 backdrop-blur-sm p-5 rounded-xl hover:bg-white/30 transition-all duration-300">
          ...
          <div className="w-full bg-gray-200/30 dark:bg-gray-600/30 rounded-full h-2.5 mt-2">
            <div className="bg-purple-500/80 h-2.5 rounded-full" style={{ width: "30%" }}></div>
          </div>
        </div>
